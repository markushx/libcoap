...
JNIEXPORT jint JNICALL JNI_OnLoad( JavaVM *jvm, void *reserved ){
	printf("JNI_OnLoad Client called: caching JVM, ENV \n" );
    cached_jvm = jvm;
...
coap_pdu_t* socket6_create_pdu(jint jhdr_ver, jint jhdr_type, jint jhdr_opt_cnt, jint jhdr_code, jint jhdr_id) {
...
void socket6_send(coap_context_t  *context, struct sockaddr_in6 *p, coap_pdu_t *pdu_ptr, jstring jdata) {
